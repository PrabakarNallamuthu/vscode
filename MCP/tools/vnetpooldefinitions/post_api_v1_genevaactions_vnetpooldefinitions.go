...
func Post_api_v1_genevaactions_vnetpooldefinitionsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePost_api_v1_genevaactions_vnetpooldefinitionsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_api_v1_GenevaActions_VnetPoolDefinitions",
		mcp.WithDescription(""),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_api_v1_genevaactions_vnetpooldefinitionsHandler(cfg),
	}
}

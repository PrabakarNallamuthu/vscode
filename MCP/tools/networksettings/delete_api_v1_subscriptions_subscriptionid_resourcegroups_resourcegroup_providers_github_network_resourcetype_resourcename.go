...
func Delete_api_v1_subscriptions_subscriptionid_resourcegroups_resourcegroup_providers_github_network_resourcetype_resourcenameHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/api/v1/subscriptions/%s/resourceGroups/%s/providers/GitHub.Network/%s/%s", cfg.BaseURL, subscriptionId, resourceGroup, resourceType, resourceName)
...
func CreateDelete_api_v1_subscriptions_subscriptionid_resourcegroups_resourcegroup_providers_github_network_resourcetype_resourcenameTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_api_v1_subscriptions_subscriptionId_resourceGroups_resourceGroup_providers_GitHub.Network_resourceType_resourceName",
		mcp.WithDescription(""),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Delete_api_v1_subscriptions_subscriptionid_resourcegroups_resourcegroup_providers_github_network_resourcetype_resourcenameHandler(cfg),
	}
}

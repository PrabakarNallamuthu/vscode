...
func Put_api_v1_subscriptions_subscriptionid_resourcegroups_resourcegroup_providers_github_network_resourcetype_resourcenameHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_api_v1_subscriptions_subscriptionid_resourcegroups_resourcegroup_providers_github_network_resourcetype_resourcenameTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_api_v1_subscriptions_subscriptionId_resourceGroups_resourceGroup_providers_GitHub.Network_resourceType_resourceName",
		mcp.WithDescription(""),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_api_v1_subscriptions_subscriptionid_resourcegroups_resourcegroup_providers_github_network_resourcetype_resourcenameHandler(cfg),
	}
}
